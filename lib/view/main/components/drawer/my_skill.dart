  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(
            percentage: 0.35, title: 'Sqlite', image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(
            percentage: 0.9,
        ...
        AnimatedLinearProgressIndicator(
            ...
            image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(
            percentage: 0.3, title: 'Provider', image: 'assets/icons/bloc.png'),
        AnimatedLinearProgressIndicator(
            percentage: 0.75, title: 'Getx', image: 'assets/icons/dart.png'),
      ],
    );
  }
}
